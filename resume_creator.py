...
resume.set_text_color(255,255,255)
resume.set_font("Arial", "B", 18)
resume.cell(20,2, "Contact Information", align="L", ln=1, fill=1)
# specific
resume.set_font("Arial", "")
resume.set_font_size(14)
resume.set_text_color(48,51,49)
...
resume.set_text_color(255,255,255)
resume.set_font("Arial", "B", 18)
resume.cell(20,2, "Education", align="L", ln=1, fill=1)
# specific
resume.set_font("Arial", "")
resume.set_font_size(14)
resume.set_text_color(48,51,49)
...
resume.set_text_color(255,255,255)
resume.set_font("Arial", "B", 18)
resume.cell(20,2, "Job Skills", align="L", ln=1, fill=1)
# specific
resume.set_font("Arial", "")
resume.set_font_size(14)
resume.set_text_color(48,51,49)
...
resume.set_text_color(255,255,255)
resume.set_font("Arial", "B", 18)
resume.cell(20,2, "Non-technical Skills", align="L", ln=1, fill=1)
# specific
resume.set_font("Arial", "")
resume.set_font_size(14)
resume.set_text_color(48,51,49)
